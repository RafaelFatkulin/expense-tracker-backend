...
export class TransactionTagController {
  ...
  async create(
    ...
    return await this.transactionTagService.createTransactionTag(createRequest);
  }
  ...
  async update(
    ...
    return await this.transactionTagService.updateTransactionTag(user.id, id, updateRequest);
  }
